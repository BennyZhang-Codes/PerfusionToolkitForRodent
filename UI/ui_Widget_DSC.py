...
class Ui_Widget_DSC(object):
    def setupUi(self, Widget_DSC):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, -8, 308, 480))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, -87, 286, 268))
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 204, 392))
